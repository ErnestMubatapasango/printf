	...
	int flags, int width, int precision, int size)
{
	...
	return (write_unsgnd(0, i, hedge, flags, width, precision, size));
}
...
int print_hexadecimal(va_list types, char hedge[],
	int flags, int width, int precision, int size)
{
	return (print_hexa(types, "0123456789abcdef", hedge,
 ...
 * Return: Number of chars printed
 */
int print_hexa(va_list types, char map_to[], char hedge[],
